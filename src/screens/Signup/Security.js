      ...
      <View style={styles.view1}>
        <Card cornerRadius={12} style={styles.card}>
          <TouchableOpacity
            ...
            <DefiSvg/>
            <Text style={styles.svgText}>Change Recovery Seed</Text>
          </TouchableOpacity>
        ...
        <Card cornerRadius={12} style={styles.card}>
          <TouchableOpacity
            ...
            <DefiSvg/>
            <Text style={styles.svgText}>Change Passcode</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => alert('Your Currency is $USD')}>
            <Icon name="chevron-forward-sharp" color="#000000" size={18} />
          </TouchableOpacity>
        ...
        <Card cornerRadius={12} style={styles.card}>
          <TouchableOpacity
            ...
            <DefiSvg/>
            <Text style={styles.svgText}>Login with Face ID</Text>
          </TouchableOpacity>
        ...
        <Card cornerRadius={12} style={styles.card}>
          <TouchableOpacity
            ...
            <DefiSvg/>
            <Text style={styles.svgText}>Login With Fingerprint</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => alert('asdasd')}>
            <Switch
              trackColor={{false: 'white', true: 'white'}}
        ...
        <Card cornerRadius={12} style={styles.card}>
          <TouchableOpacity
            ...
            <DefiSvg/>
            <Text style={styles.svgText}>Add Custodian</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => alert('Your Currency is $USD')}>
            <Icon name="chevron-forward-sharp" color="#000000" size={18} />
          </TouchableOpacity>
