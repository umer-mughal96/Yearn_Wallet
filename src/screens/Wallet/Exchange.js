...
<View style={styles.view2}>
    ...
    <TextInput style={styles.inputtext1} placeholder="00.00" placeholderTextColor='grey' keyboardType='decimal-pad' >
...
const styles = StyleSheet.create({
    ...
    {
        color:'grey', 
        marginTop:hp(1),textDecorationColor:'grey',
    ...
    fontFamily:'Poppins-Bold'
        ...
        width: hp(45),
        fontSize: 18,
        fontFamily:'Poppins-Bold',color:'green', 
