...
export const EyeSvg = () => {
  return (
    <TouchableOpacity>
      <Svg width="20" height="20" viewBox="0 0 42.296 28.197" color="black">
        <Path
          id="Icon_awesome-eye"
